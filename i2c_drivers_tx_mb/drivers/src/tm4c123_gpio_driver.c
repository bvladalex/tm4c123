...
void GPIO_Init(GPIO_Handle_T *pGPIOHandle){
	...
	uint32_t temp=0;
	if(pGPIOHandle->GPIO_PinConfig.GPIO_PinMode == GPIO_MODE_INPUT | pGPIOHandle->GPIO_PinConfig.GPIO_PinMode == GPIO_MODE_OUTPUT)
	{
	...
	*/
		...
		pGPIOHandle->pGPIOx->IEV&=~(1U<<pGPIOHandle->GPIO_PinConfig.GPIO_PinNumber);
		pGPIOHandle->pGPIOx->IM|=(1U<<pGPIOHandle->GPIO_PinConfig.GPIO_PinNumber);
	}
		...
		pGPIOHandle->pGPIOx->IBE|=(1U<<pGPIOHandle->GPIO_PinConfig.GPIO_PinNumber);
		pGPIOHandle->pGPIOx->IM|=(1U<<pGPIOHandle->GPIO_PinConfig.GPIO_PinNumber);
	}
	//int mode
...
void GPIO_IRQHandling(GPIOA_Type *pGPIOx, uint8_t PinNumber){
