...
void UARTperiph_init(void){
	...
	UART_Conf_handle.UARTConfig.parity=UART_PARITY_ODD;
	UART_Conf_handle.UARTConfig.stop_bits=UART_2_STP_BITS;
	UART_Conf_handle.UARTConfig.uart_baud=UART_BAUD_RATE_9600;
