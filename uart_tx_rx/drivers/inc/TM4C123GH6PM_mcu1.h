...
*****************************************************************************/
/*
*Modified again by VBarbalata to include system clock registry definitions
*/
...
/*Clock enable/disable for peripherals macros*/

#define GPIOA_PCLK_EN()  (SYSCTL->RCGCGPIO |= (1U<<0) )
#define GPIOB_PCLK_EN()  (SYSCTL->RCGCGPIO |= (1U<<1) )
#define GPIOC_PCLK_EN()  (SYSCTL->RCGCGPIO |= (1U<<2) )
#define GPIOD_PCLK_EN()  (SYSCTL->RCGCGPIO |= (1U<<3) )
#define GPIOE_PCLK_EN()  (SYSCTL->RCGCGPIO |= (1U<<4) )
#define GPIOF_PCLK_EN()  (SYSCTL->RCGCGPIO |= (1U<<5) )

#define GPIOA_PCLK_DIS()  (SYSCTL->RCGCGPIO &= ~(1U<<0) )
#define GPIOB_PCLK_DIS()  (SYSCTL->RCGCGPIO &= ~(1U<<1) )
#define GPIOC_PCLK_DIS()  (SYSCTL->RCGCGPIO &= ~(1U<<2) )
#define GPIOD_PCLK_DIS()  (SYSCTL->RCGCGPIO &= ~(1U<<3) )
#define GPIOE_PCLK_DIS()  (SYSCTL->RCGCGPIO &= ~(1U<<4) )
#define GPIOF_PCLK_DIS()  (SYSCTL->RCGCGPIO &= ~(1U<<5) )


////Clock gating for SPI peripherals/////////////////

#define SPI0_PCLK_EN()  (SYSCTL->RCGCSSI |= (1U<<0) )
#define SPI1_PCLK_EN()  (SYSCTL->RCGCSSI |= (1U<<1) )
#define SPI2_PCLK_EN()  (SYSCTL->RCGCSSI |= (1U<<2) )
#define SPI3_PCLK_EN()  (SYSCTL->RCGCSSI |= (1U<<3) )

#define SPI0_PCLK_DIS()  (SYSCTL->RCGCSSI &= ~(1U<<0) )
#define SPI1_PCLK_DIS()  (SYSCTL->RCGCSSI &= ~(1U<<1) )
#define SPI2_PCLK_DIS()  (SYSCTL->RCGCSSI &= ~(1U<<2) )
#define SPI3_PCLK_DIS()  (SYSCTL->RCGCSSI &= ~(1U<<3) )

////Clock gating for I2C peripherals///////////////////

#define I2C0_PCLK_EN()  (SYSCTL->RCGCI2C |= (1U<<0) )
#define I2C1_PCLK_EN()  (SYSCTL->RCGCI2C |= (1U<<1) )
#define I2C2_PCLK_EN()  (SYSCTL->RCGCI2C |= (1U<<2) )
#define I2C3_PCLK_EN()  (SYSCTL->RCGCI2C |= (1U<<3) )
				
#define I2C0_PCLK_DIS()  (SYSCTL->RCGCI2C &= ~(1U<<0) )
#define I2C1_PCLK_DIS()  (SYSCTL->RCGCI2C &= ~(1U<<1) )
#define I2C2_PCLK_DIS()  (SYSCTL->RCGCI2C &= ~(1U<<2) )
#define I2C3_PCLK_DIS()  (SYSCTL->RCGCI2C &= ~(1U<<3) )


////Clock gating macros for UART peripherals/////

#define UART0_PCLK_EN()  (SYSCTL->RCGCUART |= (1U<<0) )
#define UART1_PCLK_EN()  (SYSCTL->RCGCUART |= (1U<<1) )
#define UART2_PCLK_EN()  (SYSCTL->RCGCUART |= (1U<<2) )
#define UART3_PCLK_EN()  (SYSCTL->RCGCUART |= (1U<<3) )
#define UART4_PCLK_EN()  (SYSCTL->RCGCUART |= (1U<<4) )
#define UART5_PCLK_EN()  (SYSCTL->RCGCUART |= (1U<<5) )
#define UART6_PCLK_EN()  (SYSCTL->RCGCUART |= (1U<<6) )
#define UART7_PCLK_EN()  (SYSCTL->RCGCUART |= (1U<<7) )
				
#define UART0_PCLK_DIS()  (SYSCTL->RCGCUART &= ~(1U<<0) )
#define UART1_PCLK_DIS()  (SYSCTL->RCGCUART &= ~(1U<<1) )
#define UART2_PCLK_DIS()  (SYSCTL->RCGCUART &= ~(1U<<2) )
#define UART3_PCLK_DIS()  (SYSCTL->RCGCUART &= ~(1U<<3) )
#define UART4_PCLK_DIS()  (SYSCTL->RCGCUART &= ~(1U<<4) )
#define UART5_PCLK_DIS()  (SYSCTL->RCGCUART &= ~(1U<<5) )
#define UART6_PCLK_DIS()  (SYSCTL->RCGCUART &= ~(1U<<6) )
#define UART7_PCLK_DIS()  (SYSCTL->RCGCUART &= ~(1U<<7) )

///////Macros to disbale/reset GPIO peri

#define GPIOA_REG_RESET() GPIOA_PCLK_DIS()
#define GPIOB_REG_RESET() GPIOB_PCLK_DIS()
#define GPIOC_REG_RESET() GPIOC_PCLK_DIS()
#define GPIOD_REG_RESET() GPIOD_PCLK_DIS()
#define GPIOE_REG_RESET() GPIOE_PCLK_DIS()
#define GPIOF_REG_RESET() GPIOF_PCLK_DIS()
